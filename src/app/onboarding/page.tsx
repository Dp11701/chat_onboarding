        ...
        >
          <div className="flex flex-col items-start justify-between !h-[60vh]">
            ...
            <div className="flex flex-col items-start ">
              {/* Title */}
              <h1 className="text-[34px] leading-[54px] text-white text-center font-bold mb-2">
              ...
              {/* Button */}
              <button className=" text-white font-medium !bg-gradient-to-r from-[#26B77D] to-[#00B0A7]  px-3 py-5 rounded-[16px] shadow-[0_0_20px_#10A46940] flex items-center justify-between min-w-[320px] ">
