    ...
    >
      <div className="md:max-w-4xl w-full  rounded-2xl md:p-8">
        ...
        >
          ...
          {/* Tab Buttons - Positioned absolutely at bottom */}
          <div className="absolute bottom-4 left-4 right-4 flex gap-4 md:gap-2 w-auto lg:gap-4 z-10">
            <AnimatePresence>
              {tabs.map((tab, index) => (
                <motion.button
                  key={tab.id}
...
export default BannerPointMobile;
